...
// in submission/test/ui/views/home/components/now_playing_components_test.dart.
...
import 'package:submission/domain/usecases/get_now_playing_movies.dart' as _i2;
import 'package:submission/ui/views/home/home_provider.dart' as _i3;
...
class _FakeHomeProvider_1 extends _i1.SmartFake implements _i3.HomeProvider {
  _FakeHomeProvider_1(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class MockHomeProvider extends _i1.Mock implements _i3.HomeProvider {
  ...
  @override
  _i3.HomeProvider init() => (super.noSuchMethod(
        Invocation.method(
          #init,
          [],
        ),
        returnValue: _FakeHomeProvider_1(
          this,
          Invocation.method(
            #init,
            [],
