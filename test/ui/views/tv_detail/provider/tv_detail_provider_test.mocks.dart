...
// in submission/test/ui/views/tv_detail/provider/tv_detail_provider_test.dart.
...
import 'package:submission/domain/entities/tv.dart' as _i9;
import 'package:submission/domain/entities/tv_detail.dart' as _i7;
import 'package:submission/domain/repositories/tv_repository.dart' as _i2;
import 'package:submission/domain/usecases/get_detail_tv.dart' as _i4;
import 'package:submission/domain/usecases/get_recommended_tv.dart' as _i8;
import 'package:submission/domain/usecases/get_watchlist_tv_exist_status.dart'
    as _i10;
import 'package:submission/domain/usecases/remove_watchlist_tv.dart' as _i12;
import 'package:submission/domain/usecases/save_watchlist_tv.dart' as _i11;
...
/// A class which mocks [GetRecommendedTv].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetRecommendedTv extends _i1.Mock implements _i8.GetRecommendedTv {
  MockGetRecommendedTv() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, List<_i9.Tv>>> call(int? id) =>
      (super.noSuchMethod(
        Invocation.method(
          #call,
          [id],
...
/// A class which mocks [GetWatchlistTvExistStatus].
///
/// See the documentation for Mockito's code generation for more information.
class MockGetWatchlistTvExistStatus extends _i1.Mock
    implements _i10.GetWatchlistTvExistStatus {
  MockGetWatchlistTvExistStatus() {
    _i1.throwOnMissingStub(this);
  }
