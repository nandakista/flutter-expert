...
// in submission/test/ui/views/tv_search/provider/tv_search_provider_test.dart.
...
import 'package:submission/domain/entities/tv.dart' as _i7;
import 'package:submission/domain/repositories/tv_repository.dart' as _i2;
import 'package:submission/domain/usecases/search_tv.dart' as _i4;
...
class MockSearchTv extends _i1.Mock implements _i4.SearchTv {
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, List<_i7.Tv>>> call(String? query) =>
      (super.noSuchMethod(
        Invocation.method(
          #call,
          [query],
