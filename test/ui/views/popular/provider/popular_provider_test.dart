...
import 'popular_provider_test.mocks.dart';
...
void main() {
  ...
  setUp(() {
    ...
    provider = PopularProvider(getPopularMovies: mockGetPopularMovies)
  ...
  test('''Should perform GET Popular Movie data from usecase then return
